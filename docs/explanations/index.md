...
- [**Multi-GPU Execution**](multi_gpu.md) -- Splitting operators across devices and synchronizing parallel execution: `BatchSpec`, `ToDevice`, `SyncContext`, streams, and events.
